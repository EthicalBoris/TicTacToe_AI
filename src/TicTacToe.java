...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        Board b = new Board(); //Creates a new board Object
        AIplayer AI = new AIplayer(b); //Creates a new AIplayer object

        Point p = new Point(0, 0); //Creates a new Point object which references the 1:1 potision of the grid
        Random rand = new Random(); //Creating a random number generator

        b.displayBoard(); //function which displays the board usign . X and O
